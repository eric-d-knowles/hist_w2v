...
def filter_stopwords(input_file, output_file, removal_method, min_tokens, overwrite):
    ...
    if not overwrite and os.path.exists(output_file):
        return set()  # Return an empty set of excluded stopwords for skipped file
...
def process_file(args):
    ...
    input_file, output_file, removal_method, min_tokens, overwrite = args
    return filter_stopwords(input_file, output_file, removal_method, min_tokens, overwrite)
...
def main():
    ...
    files = [
        (os.path.join(args.input_dir, f), os.path.join(args.output_dir, f), args.removal_method, args.min_tokens, args.overwrite)
