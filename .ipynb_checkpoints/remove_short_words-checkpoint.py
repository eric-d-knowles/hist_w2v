...
def filter_short_words(input_file, output_file, removal_method, min_length, min_tokens):
...
def process_file(args):
    ...
    input_file, output_file, min_length, removal_method, min_tokens = args
    return filter_short_words(input_file, output_file, removal_method, min_length, min_tokens)
...
def main():
    ...
    files = [
        (os.path.join(args.input_dir, f), os.path.join(args.output_dir, f), args.min_length, args.removal_method, args.min_tokens)
    ...
    # Print excluded short_words summary
